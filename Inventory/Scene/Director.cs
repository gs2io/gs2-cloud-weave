...
namespace Gs2.Weave.Inventory
{
    public class Director : MonoBehaviour
    {
        ...
        [SerializeField] 
        public InventoryDirector inventoryDirector;
        ...
        private IEnumerator InitializeImpl()
        {
            while (true)
            {
                ...
                if (!inventoryDirector.isActiveAndEnabled) continue;
                break;
            }
        ...
        public void OnCreateGs2Client(Gs2Client client)
        {
            ...
            _stampSheetRunner.AddDoneStampTaskEventHandler(
                inventoryDirector.GetTaskCompleteAction()
            );
            _stampSheetRunner.AddCompleteStampSheetEvent(
                inventoryDirector.GetSheetCompleteAction()
            );
