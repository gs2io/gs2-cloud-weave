...
namespace Gs2.Weave.MoneyStoreDiscount
{
    public class Director : MonoBehaviour
    {
        ...
        [SerializeField] 
        public MoneyStoreDiscountDirector MoneyStoreDiscountDirector;
        ...
        private IEnumerator InitializeImpl()
        {
            while (true)
            {
                ...
                if (!MoneyStoreDiscountDirector.isActiveAndEnabled) continue;
                break;
            }
        ...
        public void OnCreateGs2Client(Gs2Client client)
        {
            ...
            _stampSheetRunner.AddDoneStampTaskEventHandler(
                ...
                MoneyStoreDiscountDirector.GetTaskCompleteAction()
            );
            _stampSheetRunner.AddCompleteStampSheetEvent(
                moneyDirector.GetSheetCompleteAction(),
                MoneyStoreDiscountDirector.GetSheetCompleteAction()
            );
        ...
        public void OnCreateGameSession(Gs2GameSession session)
        {
            ...
            Debug.Log("UserId: " + session.Account.UserId);
            ...
            StartCoroutine(
                MoneyStoreDiscountDirector.Run(
                    _client.Client,
                    _session.Session,
                    _stampSheetRunner,
                    config
