...
namespace Gs2.Weave.Party
{
    public class Director : MonoBehaviour
    {
        ...
        [SerializeField] 
        public PartyDirector partyDirector;
        ...
        private IEnumerator InitializeImpl()
        {
            while (true)
            {
                ...
                if (!partyDirector.isActiveAndEnabled) continue;
                break;
            }
        ...
        {
            unitDirector.unitWidget.gameObject.SetActive(true);
            unitDirector.debugUnitControlWidget.gameObject.SetActive(true);
        }

        public void OnClickShowPartyWidget()
        {
            partyDirector.partyListWidget.gameObject.SetActive(true);
        }
